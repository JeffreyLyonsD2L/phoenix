...
public class TenantIdByteConversionTest {
    ...
    public static Collection<Object[]> data() {
        ...
        testCases.add(new Object[] {
                getDataSchema(PVarchar.INSTANCE),
                false,
        ...
        //Int
        testCases.add(new Object[] {
                getDataSchema(PInteger.INSTANCE),
                false,
        ...
        // UnsignedInt
        testCases.add(new Object[] {
                getDataSchema(PUnsignedInt.INSTANCE),
                false,
                PNameFactory.newName("2147483646"),
        ...
        //UnsignedLong
        testCases.add(new Object[] {
                getDataSchema(PUnsignedLong.INSTANCE),
                false,
                PNameFactory.newName("9223372036854775806"),
        ...
        //TinyInt
        testCases.add(new Object[] {
                getDataSchema(PTinyint.INSTANCE),
                false,
        ...
        //UnsignedTinyInt
        testCases.add(new Object[] {
                getDataSchema(PUnsignedTinyint.INSTANCE),
                false,
                PNameFactory.newName("126"),
        ...
        //SmallInt
        testCases.add(new Object[] {
                getDataSchema(PSmallint.INSTANCE),
                false,
        ...
        //UnsignedSmallInt
        testCases.add(new Object[] {
                getDataSchema(PUnsignedSmallint.INSTANCE),
                false,
                PNameFactory.newName("32766"),
        ...
        //UnsignedFloat
        testCases.add(new Object[] {
                getDataSchema(PUnsignedFloat.INSTANCE),
                false,
                PNameFactory.newName("3.402823466"),
        ...
        //Double
        testCases.add(new Object[] {
                getDataSchema(PDouble.INSTANCE),
                false,
        ...
        //UnsignedDouble
        testCases.add(new Object[] {
                getDataSchema(PUnsignedDouble.INSTANCE),
                false,
                PNameFactory.newName("1.7976931348623158"),
        ...
        //UnsignedDecimal
        testCases.add(new Object[] {
                getDataSchema(PDecimal.INSTANCE),
                false,
                PNameFactory.newName("3.402823466"),
        ...
        //Boolean
        testCases.add(new Object[] {
                getDataSchema(PBoolean.INSTANCE),
                false,
    ...
    public static RowKeySchema getDataSchema (final PDataType data) {
